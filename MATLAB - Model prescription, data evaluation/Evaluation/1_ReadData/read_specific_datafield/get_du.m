function [result_list] = get_du(data_matrix, index_list)
...
%   - result_list: A cell array containing the data extracted based on the indices.
    ...
    for i = 1:length(index_list)
        ...
        [filtered_values, adjusted_timestamps] = filter_and_adjust_timestamps({inner_dat.stateVars.phi_np_array_list.timestamp(1), inner_dat.mouse_input.q_array_list.ddx_m, inner_dat.mouse_input.q_array_list.timestamp});
